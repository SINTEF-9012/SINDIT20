...
class SemanticKGPersistenceService:
    ...
    def graph_query(self, query:str, accept_content:str)-> any:
        '''
        Execute a query on the graph database, including SELECT, CONSTRUCT, ASK, DESCRIBE queries.
        :param query: The query to be executed
        :param accept_content: The content type of the response. Accepted values: application/sparql-results+json, application/sparql-results+xml, text/csv
